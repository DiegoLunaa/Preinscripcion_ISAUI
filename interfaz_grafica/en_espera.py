...
def abrir_ventana_en_espera(aspirantes):
    ...
    """boton_cerrar_sesion = Button(esperando, text="CERRAR SESIÓN", width=14, fg="White", font=("Arial", 12), bg="#1F6680",borderwidth=2)
    ...
    boton_aspirantes = Button(esperando, text="ASPIRANTES", width=14, fg="White", font=("Arial", 12), bg="#274357",borderwidth=2)
    boton_aspirantes.place(x=64, y=184) 
        
    boton_cupos = Button(esperando, text="CUPOS", width=14, fg="White", font=("Arial", 12), bg="#274357",borderwidth=2)
